...
fprintf('Entering UMBatchPrinComp V1.0 SPM12 Compatible\n');
...
if exist([FULLSCRIPTNAME '_options.m'],'file') 
  ...
  %
  fprintf('Found "pcafMRI_options.m (%s)", executing that.\n',[FULLSCRIPTNAME '_options.m']);
  fprintf('- - - - - - - - - - - - - - - - - - - - - -\n')
  try
    ...
    fprintf('   pcafMRI_options.m file\n');
