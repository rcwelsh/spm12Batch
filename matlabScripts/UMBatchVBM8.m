...
fprintf('Entering UMBatchVBM8 V2.0 SPM12 Compatible\n');
...
Vo.dim     = Vi(1).dim;
Vo.mat     = Vi(1).mat;
Vo.descrip = ['Skull Stripped spm12Batch/VMB8 ' Vi(1).descrip];
Vo.dt      = Vi(1).dt;
...
Vo.dim     = Vi(1).dim;
Vo.mat     = Vi(1).mat;
Vo.descrip = ['Skull Stripped spm12Batch/VMB8 (intensity normalized)' Vi(1).descrip];
Vo.dt      = Vi(1).dt;
