...
newSeg -B -M ImagingData/SubjectsDerived -a func/Rest/coReg/ANTs -h N4_mprage_noFace -w func/Rest/coReg/ANTs/newSeg TestSubject

DATE=`date`
echo "${DATE} : ${USER} : antsfMRI -B -M ImagingData/SubjectsDerived -f func/Rest -h N4_mprage_noFace -on WM_ -v c2N4_mprage_noFace -w coReg/ANTs TestSubject"
antsfMRI -B -M ImagingData/SubjectsDerived -f func/Rest -h N4_mprage_noFace -on WM_ -v c2N4_mprage_noFace -w coReg/ANTs TestSubject

DATE=`date`
echo "${DATE} : ${USER} : antsfMRI -B -M ImagingData/SubjectsDerived -f func/Rest -h N4_mprage_noFace -on CSF_ -v c3N4_mprage_noFace -w coReg/ANTs TestSubject"
antsfMRI -B -M ImagingData/SubjectsDerived -f func/Rest -h N4_mprage_noFace -on CSF_ -v c3N4_mprage_noFace -w coReg/ANTs TestSubject
